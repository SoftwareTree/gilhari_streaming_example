...
echo ** Start a streaming query for all Employee objects, get first two >> curl.log
curl -X GET "http://localhost:%port%/gilhari/v1/Employee/startStream?maxObjects=2"  -H "Content-Type: application/json" >> curl.log
echo. >> curl.log
echo. >> curl.log


echo ** Fetch 3 more Employee objects from the stream >> curl.log
curl -X GET "http://localhost:%port%/gilhari/v1/Employee/fetchMore?maxObjects=3"  -H "Content-Type: application/json" >> curl.log
echo. >> curl.log
echo. >> curl.log

echo ** Fetch the remaining Employee objects from the stream >> curl.log
curl -X GET "http://localhost:%port%/gilhari/v1/Employee/fetchMore?maxObjects=-1"  -H "Content-Type: application/json" >> curl.log
echo. >> curl.log
echo. >> curl.log

echo ** Close the streaming query for the Employee objects >> curl.log
curl -X GET "http://localhost:%port%/gilhari/v1/Employee/closeStream"  -H "Content-Type: application/json" >> curl.log
echo. >> curl.log
echo. >> curl.log

echo ** Close again the streaming query for the Employee objects >> curl.log
curl -X GET "http://localhost:%port%/gilhari/v1/Employee/closeStream"  -H "Content-Type: application/json" >> curl.log
echo. >> curl.log
echo. >> curl.log

echo ** Close once again the streaming query for the Employee objects >> curl.log
curl -X GET "http://localhost:%port%/gilhari/v1/Employee/closeStream"  -H "Content-Type: application/json" >> curl.log
echo. >> curl.log
echo. >> curl.log
